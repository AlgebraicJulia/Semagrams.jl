...
@bind g Semagram("http://127.0.0.1:8080/apps/graph/target/scala-3.1.3/semagrams-graph-app-fastopt/main.js", SchGraph, "Graph")

# ╔═╡ c280e9c1-104e-4fe8-a55a-5df45c6c2f69
@acset_type Graph2(SchGraph, index=[:src,:tgt])
