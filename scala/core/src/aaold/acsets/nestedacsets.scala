...
//   /** Set the property `f` of part `p` to `v` */
//   def setPropProps(p: Part, pm: PropMap): NestedACSet = {
//     val sub = subacset(p)
//     val newSub = sub.copy(
//       props = sub.props ++ pm
//     )
...
//   def setPropProps(ps: Seq[Part], pm: PropMap): NestedACSet = 
//     ps match
//       case Seq() => this
...
//   def softSetPropProps(ps:Seq[Part],pm:PropMap): NestedACSet = ps match
//     case Seq() => this
//     case head +: tail => 
...
//   def remProp(p: Part, f: Property): NestedACSet = {
//     val sub = subacset(p)
//     val newSub = sub.copy(
//       props = sub.props - f
//     )
...
// case class SetPropMsg(part:Part,prop:Property)(v:prop.Value) extends Message[NestedACSet] {
//   def execute(a:NestedACSet) = a.setProp(part,prop,v)
// }

// case class RemovePropMsg(part:Part,prop:Property) extends Message[NestedACSet] {
//   def execute(a:NestedACSet) = a.remProp(part,prop)
// }
