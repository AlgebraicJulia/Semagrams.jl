...
trait Schema:
  ...
  def display = "Schema(" +
    (if tableSeq.isEmpty then ""
     else "\n  Table:   " + tableSeq.mkString(", ")) + (if fkeySeq.isEmpty then
                                                          ""
                                                        else
                                                          "\n  Hom:  " + fkeySeq
                                                            .mkString(", ")
    ) + (if attrSeq.isEmpty then ""
         else "\n  Observable: " + attrSeq.mkString(", ")) + (if globalProps.isEmpty
                                                              then ""
                                                              else
                                                                "\n  Prop: " + globalProps
                                                                  .mkString(
...
object BasicSchema:
  ...
  def apply[E <: (Elt | Property)](id: UID, elts: E*): BasicSchema =
    new BasicSchema(
      id,
