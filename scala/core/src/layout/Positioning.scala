...
trait BoxPosition {
  /**
  * Given the dimensions of the window, and the dimensions of the box,
  * compute the position of the top-left corner of the box.
  */
...
/**
 * Relative refers to the position inside the box, where 0+0i is the top-left corner,
 * 1+i is the bottom right, and then absolute is an offset in pixels that should be
 * added after the position in the box is calculated.
 */
