...
//     def hasProps(fs: Iterable[Property]): Boolean =
//       d.getProps().contains(fs.toSeq: _*)
...
//     def +[T](kv: (Property { type Value = T }, T)): Data =
//       d.setProp(kv._1, kv._2)
...
//   def apply(props: PropMap = PropMap()) =
//     val pd = summon[PartData]
//     pd.fromProps(props)
