package org.algebraicjulia.semagrams.acsets
...
import org.algebraicjulia.semagrams.acsets.ACSet
...
/** A similar strategy to [[org.algebraicjulia.semagrams.acsets.AbstractHom]] is used for
...
/** This is a member of the category of elements of an acset. It extends
  * [[org.algebraicjulia.semagrams.Entity]], which means that it can be used as a key for sprites
  * in Semagrams.
  */
